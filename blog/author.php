              ...
              echo("
                <div class='col-md-4 col-sm-6'>
                  <a class='d-inline-block is-hoverable' href='./author-single.php?author_id=".$blog_creator['creator_id']."'>
                    <img class='img-fluid rounded' src='$blog_creator[profile_photo_thumbnail_name]' alt='$blog_creator[first_name] $blog_creator[last_name]' width='150' height='150'>
